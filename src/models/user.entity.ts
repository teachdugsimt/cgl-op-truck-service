...
@Index("dtb_user_pkey", ["id"], { unique: true })
@Entity("dtb_user", { schema: "public" })
export class DtbUser {
  ...
  // @ManyToMany(() => DtbTruck, (dtbTruck) => dtbTruck.dtbUsers)
  // @JoinTable({
  //   name: "dtb_truck_driver",
  //   joinColumns: [{ name: "driver_id", referencedColumnName: "id" }],
  //   inverseJoinColumns: [{ name: "truck_id", referencedColumnName: "id" }],
  //   schema: "public",
  // })
  // dtbTrucks: DtbTruck[];

  // @ManyToMany(() => DtbPermission, (dtbPermission) => dtbPermission.dtbUsers)
  // dtbPermissions: DtbPermission[];

  // @ManyToMany(() => DtbRole, (dtbRole) => dtbRole.dtbUsers)
  // dtbRoles: DtbRole[];

  // @OneToMany(() => DtbWaybill, (dtbWaybill) => dtbWaybill.primaryDriver)
  // dtbWaybills: DtbWaybill[];

  // @OneToMany(() => DtbWaybill, (dtbWaybill) => dtbWaybill.rejectByUser)
  // dtbWaybills2: DtbWaybill[];

  // @OneToMany(() => DtbWaybill, (dtbWaybill) => dtbWaybill.secondaryDriver)
  // dtbWaybills3: DtbWaybill[];
}
